...
defineLazyProperty(discord, 'actions', () => ({ ...require('@revenge-mod/discord/actions') }))
defineLazyProperty(discord, 'common', () => ({ ...require('@revenge-mod/discord/common') }))
defineLazyProperty(discord, 'design', () => ({ ...require('@revenge-mod/discord/design') }))
defineLazyProperty(discord, 'native', () => ({ ...require('@revenge-mod/discord/native') }))
...
_initExts.push((api, { manifest: { id } }) =>
    defineLazyProperty(api, 'logger', () => new Logger(`Revenge > Plugins (${id})`)),
)
